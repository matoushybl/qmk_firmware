...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT_65_ansi(
        ...
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RSFT,  KC_END,
        KC_LCTL, KC_LALT, KC_LGUI,                             KC_SPC,                    MO(_FL), KC_LEFT, KC_DOWN, KC_UP, KC_RGHT,  MO(_FL)
    ),
    ...
    [_FL] = LAYOUT_65_ansi(
        ...
        _______,   _______, KC_VOLU,   _______, _______, _______, _______, _______, _______, _______, KC_PSCR, _______, _______, _______, _______,
        _______, KC_MPRV, KC_VOLD, KC_MNXT, _______, KC_INS, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, _______, _______,          _______, _______,
        RGB_HUI,          RGB_SAI, RGB_VAI, RGB_MOD, BL_DEC,  BL_TOGG, BL_INC,  _______, _______, _______, _______, KC_MPLY, KC_VOLU, KC_MUTE,
        RGB_HUD, RGB_SAD, RGB_TOG,                            RGB_MOD,                   _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_END ),
   [2] = LAYOUT_65_ansi(
       RESET,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,  KC_INS,
  ...
  [3] = LAYOUT_65_ansi(
      ...
      _______, _______, _______,                            KC_BTN2,                   _______, _______, _______, _______, _______, _______
  ),
};
